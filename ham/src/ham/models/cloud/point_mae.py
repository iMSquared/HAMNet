...
# from ham.models.sdf.encoder.point_tokens import SpatialSort, HilbertCode
...
from ham.util.config import recursive_replace_map, ConfigBase
...
def get_pos_enc_module(
    ...
    if pos_embed_type == 'nerf':
        # FIXME(ycho): hardcoded pos_embed dimensions
...
def main():
    ...
    x = th.randn((4, 2048, 3), device='cuda:0')
    aux = {}
    y = subsample(x, 512, aux=aux)
    print(y.shape)
    print(y.amin(), y.amax())
    print(aux['index'].shape)
    print(aux['index'].amin())
    print(aux['index'].amax())

    aux = {}
    y = subsample(x, 512, aux=aux, fps=True)
    print(y.shape)
    print(y.amin(), y.amax())
    print(aux['index'].shape)
    print(aux['index'].amin())
