...
from ham.env.scene.util import sample_stable_poses
...
class MeshObjectSet(ObjectSet):
    ...
    def __init__(self, cfg: Config):
        ...
        for k, v in tqdm(self.__mesh.items(), desc='pose'):
            # FIXME(ycho): height=table_dims[2] assumes
            # table is on the ground.
            # TODO(ycho): should _probably_ use a different function;
