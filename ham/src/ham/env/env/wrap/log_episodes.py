...
class LogEpisodes(WrapperEnv):
    ...
    class Config(ConfigBase):
        log_dir: str = '/tmp/ham/log-episodes'
    ...
    def _do_step(self, act, obs, rew, done, info):
        ...
        # FIXME(ycho): the below code will _only_ work
...
def main():
    ...
    from ham.models.rl.v2.ppo_config import DomainConfig
    cfg = DomainConfig(
        num_env=4,
        num_obs=4,
        num_act=1)
